...
);CREATE INDEX "ix_AgeAt_external_id_AgeAt_id" ON "AgeAt_external_id" ("AgeAt_id");CREATE INDEX "ix_AgeAt_external_id_external_id" ON "AgeAt_external_id" (external_id);
