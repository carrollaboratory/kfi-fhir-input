...
linkml_meta = LinkMLMeta({'default_prefix': 'kfi_fhir_sparks',
     ...
     'prefixes': {'cdc_rec': {'prefix_prefix': 'cdc_rec',
                  ...
                  'unknown': {'prefix_prefix': 'unknown',
                              'prefix_reference': 'https://need-more-info.org'},
...
class Period(ConfiguredBaseModel):
    ...
    period_start: Optional[date] = Field(default=None, title="Start", description="""Start attribute for a FHIR period data type.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Period', 'PractitionerRole'], 'slot_uri': 'kfi:start'} })
...
class ResearchSubject(HasAccessPolicy):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'fhir_profile': {'tag': 'fhir_profile',
                                          'value': 'https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/ncpi-Study-Participant'},
                         'fhir_resource': {'tag': 'fhir_resource',
                                           'value': 'ResearchSubject'}},
         'from_schema': 'https://carrollaboratory.github.io/kfi-fhir-input/resarch_subject',
         'slot_usage': {'research_subject_id': {'identifier': True,
                                                'name': 'research_subject_id',
                                                'range': 'string',
                                                'required': True}},
         'title': 'Research Subject'})

    research_subject_id: str = Field(default=..., title="Research Subject ID", description="""Research Subject Global ID (ResearchSubject)""", json_schema_extra = { "linkml_meta": {'domain_of': ['ResearchSubject']} })
...
class StudyMembership(HasAccessPolicy):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://carrollaboratory.github.io/kfi-fhir-input/study-membership',
         'slot_usage': {'study_membership_id': {'identifier': True,
...
class FamilyRelationship(HasAccessPolicy):
    ...
    family_relationship_id: str = Field(default=..., title="Family Relationship Global ID", description="""Family Relationship Global ID""", json_schema_extra = { "linkml_meta": {'domain_of': ['FamilyRelationship']} })
    patient_id: str = Field(default=..., title="Patient (Child)", description="""The child from the parent-child relationship""", json_schema_extra = { "linkml_meta": {'annotations': {'fhir_element': {'tag': 'fhir_element', 'value': 'patient'},
                         'fhir_profile': {'tag': 'fhir_profile',
                                          'value': 'https://nih-ncpi.github.io/ncpi-fhir-ig-2/StructureDefinition/ncpi-family-relationship'},
                         'fhir_resource': {'tag': 'fhir_resource',
                                           'value': 'FamilyMemberHistory'}},
         'domain_of': ['FamilyRelationship']} })
    relative_id: str = Field(default=..., title="Relative (Parent)", description="""The parent from the parent-child relationship""", json_schema_extra = { "linkml_meta": {'annotations': {'db_column': {'tag': 'db_column', 'value': 'relative_id'},
                         'fhir_element': {'tag': 'fhir_element',
...
class Institution(HasExternalId):
    ...
    institution_id: str = Field(default=..., title="Institution", description="""The institution this record is associated with.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Practitioner', 'Institution', 'PractitionerRole']} })
    name: Optional[str] = Field(default=None, title="Name", description="""Name of the entity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Practitioner', 'AssociatedParty', 'Institution']} })
    external_id: Optional[list[str]] = Field(default=[], title="External Identifiers", description="""Other identifiers for this entity, eg, from the submitting study or in systems link dbGaP""", json_schema_extra = { "linkml_meta": {'annotations': {'sqlalchemy.association_proxy': {'tag': 'sqlalchemy.association_proxy',
                                                          'value': 'external_id'}},
         'domain_of': ['ResearchStudy', 'ResearchStudyCollection', 'HasExternalId']} })
...
class Participant(HasExternalId):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'fhir_profile': {'tag': 'fhir_profile',
         ...
         'slot_usage': {'family_global_id': {'description': 'The family the '
                                                            'participant is a part of',
                                             'name': 'family_global_id'},
                        'participant_id': {'identifier': True,
                                           'name': 'participant_id',
                                           'range': 'string'},
    ...
    family_global_id: Optional[str] = Field(default=None, title="Family Global ID", description="""The family the participant is a part of""", json_schema_extra = { "linkml_meta": {'domain_of': ['Participant', 'Family']} })
...
class NCPIFile(HasExternalId):
    ...
    file_meta_data_id: Optional[list[str]] = Field(default=[], title="File Meta Data", description="""Representation of file metadata for NCPI""", json_schema_extra = { "linkml_meta": {'domain_of': ['NCPIFile', 'FileMetaData']} })
...
class AssociatedParty(Record):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'fhir_resource': {'tag': 'fhir_resource',
         ...
         'slot_usage': {'period_id': {'inlined': False,
                                      'multivalued': True,
                                      'name': 'period_id',
                                      'required': False}},
    ...
    period_id: Optional[list[Period]] = Field(default=[], title="Period ID", description="""Reference to a time period which defines a Start and End datatime period.""", json_schema_extra = { "linkml_meta": {'domain_of': ['AssociatedParty']} })
...
class FileMetaData(HasAccessPolicy):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'fhir_profile': {'tag': 'fhir_profile',
         ...
         'slot_usage': {'file_meta_data_id': {'annotations': {'db_column': {'tag': 'db_column',
    ...
    file_meta_data_id: str = Field(default=..., title="File Meta Data", description="""Representation of file metadata for NCPI""", json_schema_extra = { "linkml_meta": {'annotations': {'db_column': {'tag': 'db_column',
                                       'value': 'file_meta_data_id'},
                         'target_slot': {'tag': 'target_slot',
                                         'value': 'file_meta_data_id'}},
         'domain_of': ['NCPIFile', 'FileMetaData']} })
...
class Family(HasExternalId):
    ...
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'annotations': {'fhir_profile': {'tag': 'fhir_profile',
         ...
         'slot_usage': {'family_global_id': {'identifier': True,
                                             'name': 'family_global_id',
                                             'range': 'string',
                                             'required': True}},
         'title': 'Family'})
