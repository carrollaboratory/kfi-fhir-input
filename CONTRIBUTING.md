# Contributing to kfi-fhir-input

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
kfi-fhir-input. These guidelines are not strict rules.
...
The kfi-fhir-input team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the kfi-fhir-input technical leads
...
[issues]: https://github.com/carrollaboratory/kfi-fhir-input/issues/
[pulls]: https://github.com/carrollaboratory/kfi-fhir-input/pulls/
